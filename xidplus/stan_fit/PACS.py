...
def all_bands_gaussian(PACS_100,PACS_160,chains=4,iter=1000):
    ...
    f_sig_100 = PACS_100.prior_flux_sig / (PACS_100.prior_flux_upper - PACS_100.prior_flux_lower)
    f_sig_160 = PACS_160.prior_flux_sig / (PACS_160.prior_flux_upper - PACS_160.prior_flux_lower)
