...
def MIPS_24_log10(MIPS_24,chains=4,iter=1000):
    """
    Fit the MIPS 24 band
...
def MIPS_24_gaussian(MIPS_24,chains=4,iter=1000):
    """
    Fit the MIPS 24 band with gaussian prior
    ...
    f_sig_24 = MIPS_24.prior_flux_sig / (MIPS_24.prior_flux_upper - MIPS_24.prior_flux_lower)
