...
fit=SPIRE.all_bands(prior250,prior350,prior500,num_samples=750,num_warmup=750)
posterior=xidplus.posterior_numpyro(fit,[prior250,prior350,prior500])
#Save results
outfile=output_folder+'SPIRE_vanilla_'+str(tiles[taskid-1])+'_'+str(order)+'.pkl'
with open(outfile, 'wb') as f:
